...
public class Sequence{
	...
	public Sequence(Player p1, Player p2, long time){
		player1 = p1;
		player2 = p2;
		key1 = 0;
		key2 = 0;
		...
		redx = new Texture("sequence/x.png");
		redcheck = new Texture("sequence/check.jpg");
		background = new Texture("sequence/rememberbackground.png");
		UP = new Texture("sequence/UP.png");
		DOWN = new Texture("sequence/DOWN.png");
		LEFT = new Texture("sequence/LEFT.png");
		RIGHT = new Texture("sequence/RIGHT.png");
	...
	public void render(Batch batch){
		...
		if (gamerun == true){
			if(seconds < 3){
				//centerText(font, "" + seconds, 600);
				font.draw(batch, ""+(3-seconds), 710, 500);
			}
			else{
